...
public interface TradeRepository {
     ...
     * Used by TradeClassifier to count existing positions for NEWBUY/REBUY
     * classification.
     */
     ...
     *
     * @return Map with metrics: total_open_trades, long_positions, short_positions,
     *         total_exposure_value, avg_holding_hours
     */
