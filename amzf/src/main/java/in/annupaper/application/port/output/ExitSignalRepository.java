...
public interface ExitSignalRepository {
     ...
     */
    List<ExitSignal> findByTradeAndReason(String tradeId, ExitReason exitReason);
     ...
     */
    ExitSignal findLatestByTradeAndReason(String tradeId, ExitReason exitReason);
     ...
     */
    int generateEpisode(String tradeId, ExitReason exitReason);
