...
public final class RecoveryManager {
    ...
    private void handleAfterMarket(String symbol, Instant sessionStart, Instant sessionEnd) {
        ...
        HistoricalCandle latestCandle = candleStore.getLatest(symbol, TimeframeType.MINUTE_1);
        ...
        if (backfilled > 0) {
            // Regenerate aggregated candles (25-min and 125-min) from backfilled 1-min
            // candles
