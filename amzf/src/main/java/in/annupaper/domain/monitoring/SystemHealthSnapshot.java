...
public class SystemHealthSnapshot {
    ...
    public SystemHealthSnapshot(
            ...
            int longPositions,
            int shortPositions,
            double totalExposureValue,
            double avgHoldingHours,
            int pendingTradeIntents,
            int pendingExitIntents,
            int pendingOrders,
            int activeBrokers,
            int expiredBrokerSessions,
            int expiringSoonBrokerSessions) {
    ...
    public double getTotalExposureValue() { return totalExposureValue; }
    public double getAvgHoldingHours() { return avgHoldingHours; }
    public int getPendingTradeIntents() { return pendingTradeIntents; }
    public int getPendingExitIntents() { return pendingExitIntents; }
    public int getPendingOrders() { return pendingOrders; }
    public int getActiveBrokers() { return activeBrokers; }
    public int getExpiredBrokerSessions() { return expiredBrokerSessions; }
    public int getExpiringSoonBrokerSessions() { return expiringSoonBrokerSessions; }
