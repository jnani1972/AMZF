...
public record ValidationResult(
    ...
    public static class Builder {
        ...
        public Builder logImpact(BigDecimal logImpact) {
            this.logImpact = logImpact;
            return this;
        }

        public Builder exposureAfter(BigDecimal exposureAfter) {
            this.exposureAfter = exposureAfter;
            return this;
        }
