...
public record MtfSymbolConfig(
        ...
        Instant updatedAt) {
    /**
     * Resolve effective configuration by merging symbol overrides with global
     * defaults.
     * Returns a complete MtfGlobalConfig with all non-null symbol values taking
     * precedence.
     */
    public MtfGlobalConfig resolveEffective(MtfGlobalConfig global) {
        return new MtfGlobalConfig(
                ...
                strengthThresholdVeryStrong != null ? strengthThresholdVeryStrong
                        : global.strengthThresholdVeryStrong(),
