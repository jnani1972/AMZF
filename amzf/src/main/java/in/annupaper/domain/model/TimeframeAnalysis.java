...
public record TimeframeAnalysis(
    ...
    public int getZoneForPrice(BigDecimal price) {
        ...
        BigDecimal distFromFloor = price.subtract(tfLow);
        if (distFromFloor.compareTo(BigDecimal.ZERO) <= 0)
            return 1;
    ...
    public BigDecimal getDistToFloorPct(BigDecimal price) {
        if (tfLow.compareTo(BigDecimal.ZERO) == 0)
    ...
    public static class Builder {
        ...
        public Builder timeframeType(TimeframeType type) {
            this.timeframeType = type;
            return this;
        }

        public Builder analysisTime(Instant time) {
            this.analysisTime = time;
            return this;
        }

        public Builder tfLow(BigDecimal low) {
            this.tfLow = low;
            return this;
        }

        public Builder tfHigh(BigDecimal high) {
            this.tfHigh = high;
            return this;
        }

        public Builder maxDrop(BigDecimal drop) {
            this.maxDrop = drop;
            return this;
        }

        public Builder maxDropPct(BigDecimal pct) {
            this.maxDropPct = pct;
            return this;
        }

        public Builder numZones(int n) {
            this.numZones = n;
            return this;
        }

        public Builder currentZone(int z) {
            this.currentZone = z;
            return this;
        }

        public Builder inBuyZone(boolean in) {
            this.inBuyZone = in;
            return this;
        }

        public Builder buyZoneScore(BigDecimal score) {
            this.buyZoneScore = score;
            return this;
        }

        public Builder dropDistribution(List<BigDecimal> dist) {
            this.dropDistribution = dist;
            return this;
        }
