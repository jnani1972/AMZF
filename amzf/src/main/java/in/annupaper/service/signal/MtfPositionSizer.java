...
public final class MtfPositionSizer {
     ...
     * @param effectiveCeiling      Most conservative ceiling (min of HTF/ITF/LTF
     *                              ceilings)
     * @param pWin                  Probability of hitting ceiling before floor
     * @param pFill                 Probability of order getting filled
     * @param kelly                 Full Kelly fraction (signal edge/strength only,
     *                              K)
     * @param confluenceMultiplier  Multiplier based on confluence strength (0.5x to
     *                              1.2x)
     ...
     * @param openTrades            All open trades for portfolio/symbol risk
     *                              calculation
    ...
    public static PositionSizeResult calculatePositionSize(
        ...
        // kelly_qty = (capital * K_eff * kelly_fraction * confluence_multiplier) /
        // price
     ...
     *
     * This is similar to initial entry but with stricter constraints since we're
     * averaging down.
    ...
    public static PositionSizeResult calculateAddSize(
        ...
        // Higher fill probability when averaging down (market has moved in our
        // direction)
