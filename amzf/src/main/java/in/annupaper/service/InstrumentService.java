...
public final class InstrumentService {
    ...
    public InstrumentService(InstrumentRepository instrumentRepo, BrokerAdapterFactory brokerFactory) {
    ...
    public int downloadInstruments(String brokerId) {
        ...
        try {
            ...
            BrokerAdapter adapter = brokerFactory.create(brokerCode, "SYSTEM_INSTRUMENT_DOWNLOAD");
            if (adapter == null) {
            ...
            List<BrokerAdapter.Instrument> instruments = adapter.getInstruments()
    ...
    public void downloadAllInstruments() {
        ...
        totalInstruments += downloadInstruments(BrokerIds.FYERS);

        // Can add more brokers later
        // totalInstruments += downloadInstruments("B_DHAN");
     ...
     */
    public List<InstrumentRepository.InstrumentSearchResult> search(String query) {
