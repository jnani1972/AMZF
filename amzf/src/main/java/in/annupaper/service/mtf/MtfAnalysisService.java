...
import in.annupaper.domain.model.MTFConfig;
import in.annupaper.domain.model.TimeframeAnalysis;
...
public final class MtfAnalysisService {
    ...
    private final BiFunction<String, TimeframeType, List<HistoricalCandle>> candleProvider;

    public MtfAnalysisService(BiFunction<String, TimeframeType, List<HistoricalCandle>> candleProvider) {
    ...
    public TimeframeAnalysis analyzeTimeframe(String symbol, TimeframeType tfType, BigDecimal currentPrice) {
        List<HistoricalCandle> candles = candleProvider.apply(symbol, tfType);
     ...
     */
    private BigDecimal calculateMaxDrop(List<HistoricalCandle> candles) {
     ...
     */
    private List<BigDecimal> calculateDropDistribution(List<HistoricalCandle> candles, BigDecimal maxDropPct,
            int numZones) {
