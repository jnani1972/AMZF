...
public interface TradeManagementService {
     ...
     * Activates trailing stop if not already active and activation threshold reached.
     *
     ...
     * @param activate Whether to activate trailing stop (first time threshold reached)
     */
     ...
     */
    void closeTradeOnExitFill(String tradeId, BigDecimal exitPrice, Integer exitQty, String exitReason, Instant exitTimestamp);
